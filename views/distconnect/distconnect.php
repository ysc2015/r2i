        ...
        <div class="row items-push">
            <div class="col-sm-8">
                <h1 class="page-heading">
                    Réseau de Distribution <small>[Raccordements]</small>
                </h1>
            </div>
                ...
                <form class="js-validation-bootstrap form-horizontal push-10-t push-10">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-3">
                            ...
                            <textarea class="form-control" id="pln_ctrl_motif" name="pln_ctrl_motif" rows="3" placeholder="motif ..."></textarea>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-md-3">
                    ...
                    <div class="form-group">
                        <div class="col-md-3">
                            <button class="btn btn-primary add-distconnect" type="button">Enregistrer</button>
                        </div>
                    </div>
                </form>
            </div>
