                                ...
                                <ul class="nav-users push-10-t push">
                                    <li>
                                        <a href="base_pages_profile.php">
                                            <?php $r2i->get_avatar('', 'male'); ?>
                                            <i class="fa fa-circle text-success"></i> <?php $r2i->get_name('male'); echo "\n"; ?>
                                            <div class="font-w400 text-muted"><small>Graphic Designer</small></div>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="base_pages_profile.php">
                                            <?php $r2i->get_avatar('', 'female'); ?>
                                            <i class="fa fa-circle text-warning"></i> <?php $r2i->get_name('female'); echo "\n"; ?>
                                    ...
                                    <li>
                                        <a href="base_pages_profile.php">
                                            <?php $r2i->get_avatar('', 'male'); ?>
                                            <i class="fa fa-circle text-danger"></i> <?php $r2i->get_name('male'); echo "\n"; ?>
                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <a class="block block-link-hover2" href="base_pages_profile.php">
                            ...
                            <div class="block-content block-content-full text-center bg-image" style="background-image: url('<?php echo $r2i->assets_folder; ?>/img/photos/photo2.jpg');">
                                <div>
                                    <?php $r2i->get_avatar(1, '', 96, true); ?>
                                </div>
                                <div class="h5 text-white push-15-t push-5"><?php $r2i->get_name('female'); ?></div>
