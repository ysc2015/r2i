...
<div class="content">
    ...
    <form class="js-validation-bootstrap form-horizontal">
        <div class="form-group">
              <input type="radio" id="res_type" name="res_type" value="ResdeTrnsport" onclick="activer()">
                 Réseau de Transport <br>
              <input type="radio" id="res_type" name="res_type" value="ResdeDistri" onclick="desactiver()">
