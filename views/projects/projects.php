                ...
                <div class="row">
                    <div class="col-md-7">
                        <form class="js-validation-bootstrap form-horizontal" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <div class="col-md-8 col-md-offset-4">
                                    <button class="btn btn-sm btn-primary mod-project" type="submit">Enregistrer</button>
                                    <button class="btn btn-sm btn-primary validate-project" type="submit">Valider la création du projet</button>
                                </div>
                            </div>
                        </form>
                    </div>
