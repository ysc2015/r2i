...
$r2i->inc_side_overlay             = false;
$r2i->inc_sidebar                  = 'frontend_sidebar.php';
$r2i->inc_header                   = 'frontend_header.php';

// Frontend Header Options
$r2i->l_header_transparent         = true;     // True: Transparent header (if also fixed, it will get a solid dark background color on scrolling), False: White solid header

// Frontend Sidebar Options
$r2i->l_sidebar_mini               = true;     // True: Mini Sidebar Mode (> 991px), False: Disable mini mode
