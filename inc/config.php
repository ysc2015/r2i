...
$one                               = new Template('R2I', '1.0', 'assets'); // Name, version and assets folder's name

// Global Meta Data
$one->author                       = 'free';
$one->robots                       = 'noindex, nofollow';
$one->title                        = 'R2I - Admin Dashboard Template & UI Framework';
$one->description                  = 'R2I - Admin Dashboard Template & UI Framework created by pixelcave and published on Themeforest';
...
$one->main_nav                     = array(
    ...
    array(
        'name'  => '<span class="sidebar-mini-hide">Tests</span>',
        'type'  => 'heading'
    ),
