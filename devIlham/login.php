        ...
        <div class="col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3 col-lg-4 col-lg-offset-4">
            ...
            <div class="block block-themed animated fadeIn">
                ...
                <div class="block-content block-content-full block-content-narrow">
                    <!-- Login Title -->
                    <h1 class="h2 font-w600 push-30-t push-5"><?php echo $r2i->name; ?></h1>
...
<div class="push-10-t text-center animated fadeInUp">
    <small class="text-muted font-w600"><span class="js-year-copy"></span> &copy; <?php echo $r2i->name . ' ' . $r2i->version; ?></small>
</div>
<!-- END Login Footer -->
...
<!-- Form JS Code -->
<script src="<?php echo $r2i->assets_folder; ?>/js/forms.js"></script>
