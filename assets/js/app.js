...
var App = function() {
    ...
    // parse JSON
    var getJsonObject = function (data) {
        var obj;
        try {
            obj = $.parseJSON(data);
        } catch (e) {
                        ...
                        switch ($elBlock.attr('id')) {
                         /*case 'infozone_block' :
                            ...
                            case 'synop_block' :
                                ...
                                break;
                            case 'planning_block' :
                                OT.planning.initContent();
                                break;
                            case 'listeprojet_block' :
                                ProjetSp.projet.initContent();
                                break;
                            case 'listesousprojet_block' :
                                ProjetSp.sprojet.initContent();
                                break;
                            default :
