...
ALTER TABLE `detaildevis` ADD `contact` VARCHAR(100) NOT NULL AFTER `TGC_05_04_qt`, ADD `code_site` VARCHAR(20) NOT NULL AFTER `contact`, ADD `ref_devis` VARCHAR(30) NOT NULL AFTER `code_site`, ADD `date_devis` DATE NOT NULL AFTER `ref_devis`, ADD `date_livraison` DATE NOT NULL AFTER `date_devis`;
