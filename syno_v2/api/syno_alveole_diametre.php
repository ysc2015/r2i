<?php
$tableName = 'syno_alveole_diametre';
$response = array('err' => 0, 'msg' => array(), 'extra' => null);

switch ($action) {
    case 'listForSelect':
        $stmt = $pdo->query('SELECT val_alveole_diametre as id,val_alveole_diametre as lib FROM ' . $tableName);
    ...
    case 'delete':
        ...
        $ret = DBHelper::delete($tableName, 'val_alveole_diametre IN (' . implode(',', $ids) . ')');
    ...
    case 'update':
        $post_data = array(
            'val_alveole_diametre_update' => $_POST['val_alveole_diametre_update'],

          "val_alveole_diametre" => $_POST[$lang["val_alveole_diametre_id"]],);
        $ret = DBHelper::update($tableName, 'val_alveole_diametre=:val_alveole_diametre_update', $post_data,array('val_alveole_diametre_update'));
        if ($ret !== false) {
