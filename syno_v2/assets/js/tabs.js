...
function tronconClick(obj) {
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            options = makeOptionsList(type_chambre_options, data.type_chambre_src, 'lib_type_chambre', 'lib_type_chambre');
            ...
            options = makeOptionsList(type_chambre_options, data.type_chambre_dst, 'lib_type_chambre', 'lib_type_chambre');
            ...
            options = makeOptionsList(masque_options, data.masque_src, 'nom', 'nom');
            ...
            options = makeOptionsList(type_reseau_options, data.type_reseau, 'lib_type_reseau', 'lib_type_reseau');
            ...
            options = makeOptionsList(alveole_diametre_options, data.alveole_diametre, 'val_alveole_diametre', 'val_alveole_diametre');
            ...
            options = makeOptionsList(diametre_options, data.diametre, 'valeur_diametre', 'valeur_diametre');
            ...
            options = makeOptionsList(masque_options, data.masque_dst, 'nom', 'nom');
