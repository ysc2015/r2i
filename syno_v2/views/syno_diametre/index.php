...
<div class="wrapper wrapper-content">
    <div class="row">
        <div class="col-lg-12 animated fadeInRight">
                ...
                <form class="pull-right mail-search">
                    <div class="input-group">
                        ...
                        <select id="search_by" class="form-control input-sm">
                            <option value="valeur_diametre"><?php echo $lang["valeur_diametre_label"]; ?></option>
                        </select>
                    </div>
                </form>
            ...
            <div class="mail-box-header">
                <button class="btn btn-xs btn-primary" onclick="show_hide(0)">valeur_diametre</button> 
            </div>

            <div class="mail-box">
                <table class="table table-bordered table-hover table-mail">
                    <thead>
                        <tr><th></th><th id="cell_0_0">valeur_diametre</th><th>Action</th></tr>
                    </thead>
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-sm-12 b-r">
                        ...
                        <input id="valeur_diametre_update" type="hidden" value=""> 
...
<script type="text/javascript">
    ...
    function getData() {
        ...
        if($('#valeur_diametre_update').val() !== '') {
            obj.valeur_diametre_update = $('#valeur_diametre_update').val();
        }
        return obj;
    }
            ...
            success: function (response) {
                if (response.err == 0) {
                    ...
                    for (var i = 0; i < response.data.length; i++) {
                        ...
                        html += '<input value="' + response.data[i].valeur_diametre + '" type="checkbox" class="i-checks">';
                        html += '</td>';
                        html += "<td id=\"cell_" + i + "_0\" class=\"mail-contact\">" + response.data[i].valeur_diametre + "</td>";
    ...
    function btn_edit_click(index) {
        ...
        $('#valeur_diametre_update').val(data.valeur_diametre);
