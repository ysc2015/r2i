...
<div class="wrapper wrapper-content">
    <div class="row">
        <div class="col-lg-12 animated fadeInRight">
                ...
                <form class="pull-right mail-search">
                    <div class="input-group">
                        ...
                        <select id="search_by" class="form-control input-sm">
                            <option value="lib_type_reseau"><?php echo $lang["lib_type_reseau_label"]; ?></option>
                        </select>
                    </div>
                </form>
            ...
            <div class="mail-box-header">
                <button class="btn btn-xs btn-primary" onclick="show_hide(0)">lib_type_reseau</button> 
            </div>

            <div class="mail-box">
                <table class="table table-bordered table-hover table-mail">
                    <thead>
                        <tr><th></th><th id="cell_0_0">lib_type_reseau</th><th>Action</th></tr>
                    </thead>
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-sm-12 b-r">
                        ...
                        <input id="lib_type_reseau_update" type="hidden" value=""> 
...
<script type="text/javascript">
    ...
    function getData() {
        ...
        if($('#lib_type_reseau_update').val() !== '') {
            obj.lib_type_reseau_update = $('#lib_type_reseau_update').val();
        }
        return obj;
    }
            ...
            success: function (response) {
                if (response.err == 0) {
                    ...
                    for (var i = 0; i < response.data.length; i++) {
                        ...
                        html += '<input value="' + response.data[i].lib_type_reseau + '" type="checkbox" class="i-checks">';
                        html += '</td>';
                        html += "<td id=\"cell_" + i + "_0\" class=\"mail-contact\">" + response.data[i].lib_type_reseau + "</td>";
    ...
    function btn_edit_click(index) {
        ...
        $('#lib_type_reseau_update').val(data.lib_type_reseau);
