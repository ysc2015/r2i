                ...
                <form class="js-validation-bootstrap form-horizontal push-10-t push-10">
                    ...
                    <div class="form-group">
                        <label class="col-md-4 control-label" for="FichiersRaccord">Fichiers
                            <span class="text-danger">*</span></label>
                        <div class="col-md-7">
                            <input type="file" id="FichierRacco" name="FichierRacco" accept=".xls,.xlsx,application/vnd.ms-excel,application/vnd.openxmlformats-officedocument.spreadsheetml.sheet" multiple="multiple">
                        </div>
                    </div>
