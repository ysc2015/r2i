        ...
        <div class="block block-bordered">
            ...
            <div class="block-content">
                <form class="js-validation-bootstrap form-horizontal push-10-t push-10">
                    ...
                    <div class="form-group">
                        <label class="col-md-4 control-label" for="comnd_acces">Commande Accès
                            <span class="text-danger">*</span></label>
                        <div class="col-md-7">
                            <select class="form-control" id="comnd_acces" name="comnd_acces">
                                <option value="">Séléctionnez un type</option>
                    ...
                    <div class="form-group">
                        <label class="col-md-4 control-label" for="trans_date_ca">Date Transmission CA
                            <span class="text-danger">*</span></label>
                        <div class="col-md-7">
                            <input class="form-control" type="date" id="trans_date_ca" name="trans_date_ca">
                        </div>
                    </div>


                    <div class="form-group">
                        <label class="col-md-4 control-label" for="ref_cmnd_acces">Référence Commande Accès
                            <span class="text-danger">*</span></label>
                        <div class="col-md-7">
                            <input class="form-control" type="text" id="ref_cmnd_acces" name="ref_cmnd_acces">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col-xs-12">
                                ...
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                &nbsp;&nbsp;&nbsp;&nbsp;
                                <button class="btn btn-success add-distrib-cmdctr" type="button"><i class="fa fa-check push-5-r"></i> Enregistrer</button>
                            </div>
                        </div>
                    </div>
                </form>
