...
<?php if($action == "add"): ?>
    <div class="content">
        <!-- Mega Form -->
        <h2 class="content-heading">Réseau de Distribution (Recette)</h2>
        <div class="block block-bordered">
            ...
            <div class="block-content">
                <form class="js-validation-bootstrap form-horizontal push-10-t push-10">
                    ...
                    <div class="form-group">
                        <label class="col-md-4 control-label" for="recipe_user">Date de Recette
                            <span class="text-danger">*</span></label>
                        <div class="col-md-7">
                            <input class="form-control" type="date" id="recipe_user" name="recipe_user">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-7">
                            <select class="form-control"  id="recipe_state" name="recipe_state">
                                ...
                                <option value="ajournee" id="tt"> Recette Ajournée</option>
                            </select>
                            <p> </p>
                            <div class="col-md-7">
                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col-xs-12">
                                ...
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                &nbsp;&nbsp;&nbsp;&nbsp;
                                <button class="btn btn-success add-distrib-recipe" type="button"><i class="fa fa-check push-5-r"></i> Enregistrer</button>
                            </div>
                        </div>
                    </div>
                </form>
