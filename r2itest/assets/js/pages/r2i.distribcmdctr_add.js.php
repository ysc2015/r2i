...
?>
var DistribCmdctrFormValidation = function() {
    ...
    // Add sub project
    var addDistribCmdctr= function() {
        // When the add project form is submitted
        jQuery('.add-distrib-cmdctr').on('click', function(){
            if($form.valid()) {
                ...
                formData.append('method', 'insert_distrib_cmdtctr');
...
jQuery(function(){ DistribCmdctrFormValidation.init(); });