...
?>
var DistribSwitchFormValidation = function() {
    ...
    // Add sub project
    var addDitribSwitch= function() {
        // When the add project form is submitted
        jQuery('.add-distrib-tirage').on('click', function(){
            if($form.valid()) {
                ...
                formData.append('method', 'insert_distrib_tirage');
...
jQuery(function(){ DistribSwitchFormValidation.init(); });