...
?>
var TransportCmdctrValidation = function() {
    ...
    // Add sub project
    var addTransportCmdctr= function() {
        // When the add project form is submitted
        jQuery('.add-transport-cmdctr').on('click', function(){
            if($form.valid()) {
                ...
                formData.append('method', 'insert_transport_Cmdctr');
...
jQuery(function(){ TransportCmdctrValidation.init(); });