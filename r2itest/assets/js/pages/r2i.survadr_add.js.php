...
?>
var SurvAdrValidation = function() {
    ...
    // Add sub project
    var addSurvAdr= function() {
        // When the add project form is submitted
        jQuery('.add-surv-adr').on('click', function(){
            if($form.valid()) {
                ...
                formData.append('method', 'insert_surv_adr');
...
jQuery(function(){ SurvAdrValidation.init(); });