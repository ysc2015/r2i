...
?>
var TransportRaccoFormValidation = function() {
    ...
    // Add sub project
    var addTransportRacco = function() {
        // When the add project form is submitted
        jQuery('.add-transport-racco').on('click', function(){
            if($form.valid()) {
                ...
                formData.append('method', 'insert_transport_racco');
...
jQuery(function(){ TransportRaccoFormValidation.init(); });