...
?>
var DistribRecipeFormValidation = function() {
    ...
    // Add sub project
    var addDistribRecipe= function() {
        // When the add project form is submitted
        jQuery('.add-distrib-recipe').on('click', function(){
            if($form.valid()) {
                ...
                formData.append('method', 'insert_distrib_recipe');
...
jQuery(function(){ DistribRecipeFormValidation.init(); });