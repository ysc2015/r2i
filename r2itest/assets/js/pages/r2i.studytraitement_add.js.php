...
?>
var StudyTraitementValidation = function() {
    ...
    // Add sub project
    var addStudyTraitement= function() {
        // When the add project form is submitted
        jQuery('.add-study-traitement').on('click', function(){
            if($form.valid()) {
                ...
                formData.append('method', 'insert_studytraitement');
...
jQuery(function(){ StudyTraitementValidation.init(); });