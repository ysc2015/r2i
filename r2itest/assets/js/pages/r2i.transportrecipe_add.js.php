...
var TransportRecipeFormValidation = function() {
    ...
    // Add sub project
    var addTransportRecipe = function() {
        // When the add project form is submitted
        jQuery('.add-transport-recipe').on('click', function(){
            if($form.valid()) {
                ...
                formData.append('method', 'insert_transport_recipe');
...
jQuery(function(){ TransportRecipeFormValidation.init(); });