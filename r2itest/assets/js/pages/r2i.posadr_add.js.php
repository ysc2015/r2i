...
var PosAdrValidation = function() {
    ...
    // Add sub project
    var addPosAdr= function() {
        // When the add project form is submitted
        jQuery('.add-pos-adr').on('click', function(){
            if($form.valid()) {
                ...
                formData.append('method', 'insert_pos_adr');
...
jQuery(function(){ PosAdrValidation.init(); });