            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-sm-12 b-r">
                        ...
                        <div class="form-group">
                            <label for="<?php echo $lang["type_infra_id"]; ?>">
                                <?php echo $lang["type_infra_label"]; ?>
                            </label> 
                            <select id="<?php echo $lang["type_infra_id"]; ?>" class="form-control select2">    
                            </select>
                        </div>
                        <div class="form-group">
                            <label for="<?php echo $lang["type_chambre_id"]; ?>"><?php echo $lang["type_chambre_label"]; ?></label> 
                            <select id="<?php echo $lang["type_chambre_id"]; ?>" class="form-control select2">    
                            </select>
                        </div>
                        <div class="form-group">
...
<?php echo $lang["gps_id"]; ?>: valById("<?php echo $lang["gps_id"]; ?>"),
            ...
            success: function (response) {
                if (response.err == 0) {
                    ...
                    for (var i = 0; i < response.data.length; i++) {
                        ...
                        html += "<td id=\"cell_" + i + "_1\" class=\"mail-contact\">" + nullToStr(response.data[i].ref_chambre) + "</td>";
                        html += "<td id=\"cell_" + i + "_2\" class=\"mail-contact\">" + nullToStr(response.data[i].type_infra) + "</td>";
                        html += "<td id=\"cell_" + i + "_3\" class=\"mail-contact\">" + nullToStr(response.data[i].type_chambre) + "</td>";
                        ...
                        html += "<td id=\"cell_" + i + "_5\" class=\"mail-contact\">" + nullToStr(response.data[i].gps) + "</td>";
    ...
    function btn_edit_click(index) {
        ...
        if (data.manchon_prevu == 1) {
            $('#<?php echo $lang["manchon_prevu_id"]; ?>').iCheck("check");
        } else {
            $('#<?php echo $lang["manchon_prevu_id"]; ?>').iCheck("uncheck");
        }
    ...
    $(function () {
        makeOptionsFromAPI('syno_type_infra', '<?php echo $lang["type_infra_id"]; ?>');
        makeOptionsFromAPI('syno_type_chambre', '<?php echo $lang["type_chambre_id"]; ?>');
