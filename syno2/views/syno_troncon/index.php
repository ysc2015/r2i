                ...
                <div class="row">
                    <div class="col-sm-12 b-r">
                        ...
                        <div class="form-group">
                            ...
                            <input readonly="true" id="<?php echo $lang["id_troncon_id"]; ?>" placeholder="<?php echo $lang["id_troncon_placeholder"]; ?>" class="form-control " type="text" >
                        </div>

                        <div class="form-group">
                            <label for="<?php echo $lang["chambre_src_id"]; ?>"><?php echo $lang["chambre_src_label"]; ?></label> 
                            <select id="<?php echo $lang["chambre_src_id"]; ?>" class="form-control select2">
                            </select>
                        </div>
                        <div class="form-group">
                            <label for="<?php echo $lang["chambre_dst_id"]; ?>"><?php echo $lang["chambre_dst_label"]; ?></label> 
                            <select id="<?php echo $lang["chambre_dst_id"]; ?>" class="form-control select2">
                            </select>
                        </div>
                        <div class="form-group">
                            <label for="<?php echo $lang["masque_src_id"]; ?>"><?php echo $lang["masque_src_label"]; ?></label> 
                            <select id="<?php echo $lang["masque_src_id"]; ?>" class="form-control select2">
                            </select>
                        </div>
                        <div class="form-group">
                            <label for="<?php echo $lang["masque_dst_id"]; ?>"><?php echo $lang["masque_dst_label"]; ?></label> 
                            <select id="<?php echo $lang["masque_dst_id"]; ?>" class="form-control select2">
                            </select>
                        </div>
                        <div class="form-group">
                            <label for="<?php echo $lang["alveole_src_id"]; ?>"><?php echo $lang["alveole_src_label"]; ?></label> 
                            <input id="<?php echo $lang["alveole_src_id"]; ?>" class="form-control" type="number">
                        </div>
                        <div class="form-group">
                            <label for="<?php echo $lang["alveole_dst_id"]; ?>"><?php echo $lang["alveole_dst_label"]; ?></label> 
                            <input id="<?php echo $lang["alveole_dst_id"]; ?>" class="form-control" type="number">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <select id="<?php echo $lang["type_reseau_id"]; ?>" class="form-control select2">
                            </select>
                        </div>
                        <div class="form-group">
                            <label for="<?php echo $lang["diametre_id"]; ?>"><?php echo $lang["diametre_label"]; ?></label> 
                            <select id="<?php echo $lang["diametre_id"]; ?>" class="form-control select2">
                            </select>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <select id="<?php echo $lang["passage_id"]; ?>" class="form-control select2">
                            </select>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <select id="<?php echo $lang["alveole_diametre_id"]; ?>" class="form-control select2">
                            </select>
                        </div>
                        <div class="form-group">
...
<script type="text/javascript">
    ...
    var hiddenColumns = [false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false];
...
<?php echo $lang["conduite_libre_id"]; ?>: isCheckedInt("<?php echo $lang["conduite_libre_id"]; ?>"),
...
<?php echo $lang["etat_aveole_id"]; ?>: isCheckedInt("<?php echo $lang["etat_aveole_id"]; ?>"),
<?php echo $lang["alveole_libre_4_id"]; ?>: isCheckedInt("<?php echo $lang["alveole_libre_4_id"]; ?>"),
...
<?php echo $lang["alveole_100_free_id"]; ?>: isCheckedInt("<?php echo $lang["alveole_100_free_id"]; ?>"),
<?php echo $lang["autre_id"]; ?>: valById("<?php echo $lang["autre_id"]; ?>"),
    ...
    function checkData(data) {
        ...
        if (data.<?php echo $lang["chambre_dst_id"]; ?> == data.<?php echo $lang["chambre_src_id"]; ?>) {
            showNotification("Error", ["Vous avez selectionné les mêmes chambres !"], "error");
            return false;
        }
            ...
            success: function (response) {
                if (response.err == 0) {
                    ...
                    for (var i = 0; i < response.data.length; i++) {
                        ...
                        html += "<td id=\"cell_" + i + "_3\" class=\"mail-contact\">" + nullToStr(response.data[i].masque_src) + "</td>";
                        html += "<td id=\"cell_" + i + "_4\" class=\"mail-contact\">" + nullToStr(response.data[i].masque_dst) + "</td>";
                        html += "<td id=\"cell_" + i + "_5\" class=\"mail-contact\">" + nullToStr(response.data[i].alveole_src) + "</td>";
                        html += "<td id=\"cell_" + i + "_6\" class=\"mail-contact\">" + nullToStr(response.data[i].alveole_dst) + "</td>";
                        ...
                        html += "<td id=\"cell_" + i + "_8\" class=\"mail-contact\">" + nullToStr(response.data[i].type_reseau) + "</td>";
                        html += "<td id=\"cell_" + i + "_9\" class=\"mail-contact\">" + nullToStr(response.data[i].diametre) + "</td>";
                        ...
                        html += "<td id=\"cell_" + i + "_12\" class=\"mail-contact\">" + nullToStr(response.data[i].passage) + "</td>";
                        html += "<td id=\"cell_" + i + "_13\" class=\"mail-contact\">" + nullToStr(response.data[i].longueurGC) + "</td>";
                        html += "<td id=\"cell_" + i + "_14\" class=\"mail-contact\">" + nullToStr(response.data[i].alveole_diametre) + "</td>";
                        ...
                        html += "<td id=\"cell_" + i + "_16\" class=\"mail-contact\">" + nullToStr(response.data[i].autre) + "</td>";
    ...
    function btn_edit_click(index) {
        ...
        if (data.conduite_libre == 1) {
            $('#<?php echo $lang["conduite_libre_id"]; ?>').iCheck("check");
        } else {
            $('#<?php echo $lang["conduite_libre_id"]; ?>').iCheck("uncheck");
        }
        if (data.etat_aveole == 1) {
            $('#<?php echo $lang["etat_aveole_id"]; ?>').iCheck("check");
        } else {
            $('#<?php echo $lang["etat_aveole_id"]; ?>').iCheck("uncheck");
        }
        if (data.alveole_libre_4 == 1) {
            $('#<?php echo $lang["alveole_libre_4_id"]; ?>').iCheck("check");
        } else {
            $('#<?php echo $lang["alveole_libre_4_id"]; ?>').iCheck("uncheck");
        }
        if (data.alveole_100_free == 1) {
            $('#<?php echo $lang["alveole_100_free_id"]; ?>').iCheck("check");
        } else {
            $('#<?php echo $lang["alveole_100_free_id"]; ?>').iCheck("uncheck");
        }
        ...
        $("#<?php echo $lang["type_reseau_id"]; ?>").selectpicker('refresh');
        $("#<?php echo $lang["alveole_diametre_id"]; ?>").val(data.alveole_diametre);
        $("#<?php echo $lang["alveole_diametre_id"]; ?>").selectpicker('refresh');
        $("#<?php echo $lang["passage_id"]; ?>").val(data.passage);
        $("#<?php echo $lang["passage_id"]; ?>").selectpicker('refresh');
        ...
        $("#<?php echo $lang["chambre_src_id"]; ?>").selectpicker('refresh');
        $("#<?php echo $lang["chambre_dst_id"]; ?>").selectpicker('refresh');
        $("#<?php echo $lang["masque_src_id"]; ?>").selectpicker('refresh');
        $("#<?php echo $lang["masque_dst_id"]; ?>").selectpicker('refresh');
    ...
    $(function () {
        ...
        makeOptionsFromAPI('syno_chambre', ['<?php echo $lang["chambre_src_id"]; ?>', '<?php echo $lang["chambre_dst_id"]; ?>']);
        makeOptionsFromAPI('syno_masque', ['<?php echo $lang["masque_src_id"]; ?>', '<?php echo $lang["masque_dst_id"]; ?>']);
        makeOptionsFromAPI('syno_type_reseau', '<?php echo $lang["type_reseau_id"]; ?>');
        makeOptionsFromAPI('syno_diametre', '<?php echo $lang["diametre_id"]; ?>');
        makeOptionsFromAPI('syno_passage', '<?php echo $lang["passage_id"]; ?>');
        makeOptionsFromAPI('syno_alveole_diametre', '<?php echo $lang["alveole_diametre_id"]; ?>');
