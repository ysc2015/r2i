...
<script>
    ...
    $(document).ready(function() {
        ...
        blq_pbc_dt = $('#blq_pbc_table').DataTable( {
            ...
            "serverSide": true,
            "ajax": {
                "url": 'api/ot/ot/ot_blq_pbc_liste.php?nr&type=1&idot='+(ot_dt.row('.selected').data()!=undefined?ot_dt.row('.selected').data().id_ordre_de_travail:-1)+'&rep='+$('#rep_ok').val()+'&resol='+$('#res_ok').val()
            },
            "columns": [
                { "data": "id_blq_pbc" },
        ...
        blq_pbc_dt2 = $('#blq_pbc_table2').DataTable( {
            ...
            "serverSide": true,
            "ajax": {
                "url": 'api/ot/ot/ot_blq_pbc_liste.php?nr&type=2&idot='+(ot_dt.row('.selected').data()!=undefined?ot_dt.row('.selected').data().id_ordre_de_travail:-1)+'&rep='+$('#rep_ok').val()+'&resol='+$('#res_ok').val()
            },
            "columns": [
                { "data": "id_blq_pbc" },
                { "data": "id_ordre_de_travail" },
