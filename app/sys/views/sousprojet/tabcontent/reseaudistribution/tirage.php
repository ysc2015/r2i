        ...
        <div id="dt_lineare_groupe" style="border-left: dashed 1px #000;border-right: dashed 1px #000;border-bottom: dashed 1px #000;margin-top: 5px;padding: 5px;display: none">
            ...
            <div class="form-group">
                <div class="col-md-3">
                    ...
                    <label for="dt_lineaire1">câble 720FO <span class="text-danger">*</span></label>
                ...
                <div class="col-md-3">
                    ...
                    <label for="dt_lineaire_reseau">câble 432FO <span class="text-danger">*</span></label>
                ...
                <div class="col-md-3">
                    ...
                    <label for="dt_lineaire_reseau">câble 288FO <span class="text-danger">*</span></label>
