        ...
        <div class="row items-push">
            <div class="form-group">
                ...
                <div class="col-md-6 fcomp-annexe">
                    <label for="fcomp_uploader_wrapper4">Documents livrables complementaires </label>
                    <div id="fcomp_uploader_wrapper4">
                        <div id="fcomp_uploader4"></div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="form-group">
                <div class="col-md-8">
                    ...
                    <label class="css-input switch switch-sm switch-success">
                        ...
                        Prise en charge BE : <span id="charge_be_message_distribution_cmdfintravaux"><?= ($sousProjet->distributioncmdfintravaux!==NULL && $sousProjet->distributioncmdfintravaux->date_charge_be !=NULL ?" Le ".$sousProjet->distributioncmdfintravaux->date_charge_be."" : "")?></span>
                    </label>
                </div>
            </div>
        </div>
...
<script>
    ...
    var fcomp_uploader_options4 = {
        ...
        onLoad:function(obj)
        {
            $.ajax({
                ...
                method:"POST",
                data: {idsp:get('idsousprojet'), types : '6,7,8'},
                dataType: "json",
    ...
    $(function () {
        ...
        fcomp_uploader4 = $("#fcomp_uploader4").uploadFile(fcomp_uploader_options4);
    });
