            ...
            <div class="form-group">
                <div class="col-md-3">
                    ...
                    <select class="form-control " id="drec_id_entreprise" name="drec_id_entreprise">
                        ...
                        foreach($results as $result) {
                            echo "<option value=\"$result->id_entreprise\" ". ($sousProjet->distributionrecette!==NULL && $sousProjet->distributionrecette->id_entreprise==$result->id_entreprise ?"selected": "")." >$result->lib_entreprise</option>";
                        }
                        ?>
                    </select>
                </div>
