        ...
        <div class="row items-push">
            <div class="form-group">
                ...
                <div class="col-md-3">
                    ...
                    <input  class="form-control" type="text" id="drec_code_certification" name="drec_code_certification" value="<?=($sousProjet->distributionrecette !== NULL ? $sousProjet->distributionrecette->code_certification : "")?>" placeholder="Code de Certification" placeholder="Code de Certification"  <?=  (( $drec_flag_csv!=null && $drec_fichier_certification!=null ) && ($connectedProfil->profil->profil->shortlib == "adm" || $connectedProfil->profil->profil->shortlib == "pov")  ?  '' : 'readonly' ) ?>>
                </div>
                <div class="col-md-3">
        ...
        <div class="row items-push">
            <div class="form-group">
                <div class="col-md-8">
                    ...
                    <button id="id_sous_projet_distribution_recette_pdn_integration_netgeo" class='btn btn-primary btn-sm' data-toggle="modal" data-target='#pdn_integration_netgeo-modal' data-backdrop="static" data-keyboard="false" type="button"><i class="fa fa-question push-5-r"></i> PBN Intégration netgeo</button>
