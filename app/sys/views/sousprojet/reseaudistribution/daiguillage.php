...
<div id="charge-be-confirm_distribution_aiguillage" title="Confirmer cette affectation ?">
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#id_sous_projet_distribution_aiguillage_charge_be').click(function(e){
            e.preventDefault();
            $("#charge-be-confirm_distribution_aiguillage").dialog("open");
