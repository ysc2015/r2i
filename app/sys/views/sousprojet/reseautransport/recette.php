            ...
            <div class="form-group">
                <div class="col-md-8">
                    ...
                    <label class="css-input switch switch-sm switch-success">
                        ...
                        Prise en charge BE : <span id="charge_be_message_transport_recette"><?= ($sousProjet->transportrecette!==NULL && $sousProjet->transportrecette->date_charge_be !=NULL ?" Le ".$sousProjet->transportrecette->date_charge_be."" : "")?></span>
                    </label>
...
<div id="charge-be-confirm_transport_recette" title="Confirmer cette affectation ?">
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#id_sous_projet_transport_recette_charge_be').click(function(e){
            e.preventDefault();
            $("#charge-be-confirm_transport_recette").dialog("open");
