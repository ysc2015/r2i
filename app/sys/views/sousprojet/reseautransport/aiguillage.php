        ...
        <div class="row items-push">
            <div class="form-group">
                <div class="col-md-3">
                    ...
                    <select class="form-control " id="ta_intervenant_be" name="ta_intervenant_be">
                        ...
                        foreach($results as $result) {
                            echo "<option value=\"$result->id_utilisateur\" ". ($sousProjet->transportaiguillage!==NULL && $sousProjet->transportaiguillage->intervenant_be==$result->id_utilisateur ?"selected": "")." >".strtoupper($result->prenom_utilisateur." ".$result->nom_utilisateur)."</option>";
                        }
                        ?>
                    </select>
                </div>
                ...
                <div class="col-md-3">
                    ...
                    <input class="form-control " type="date" id="ta_date_transmission_plans" name="ta_date_transmission_plans" value="<?=($sousProjet->transportaiguillage !== NULL?$sousProjet->transportaiguillage->date_transmission_plans:"")?>">
                </div>
            </div>
        </div>
        <div class="row items-push">
            ...
            <div class="form-group">
                <div class="col-md-3">
                    ...
                    <select class="form-control " id="ta_id_entreprise" name="ta_id_entreprise">
                        ...
                        foreach($results as $result) {
                            echo "<option value=\"$result->id_entreprise\" ". ($sousProjet->transportaiguillage!==NULL && $sousProjet->transportaiguillage->id_entreprise==$result->id_entreprise ?"selected": "")." >$result->lib_entreprise</option>";
                        }
                        ?>
                    </select>
                </div>
                ...
                <div class="col-md-3">
                    ...
                    <input class="form-control " type="date" id="ta_date_retour" name="ta_date_retour" value="<?=($sousProjet->transportaiguillage !== NULL?$sousProjet->transportaiguillage->date_retour:"")?>">
                </div>
                <div class="col-md-3">
        ...
        <div class="row items-push">
            <div class="form-group">
                ...
                <div class="col-md-4">
                    ...
                    <textarea class="form-control" id="ta_retour_presta" name="ta_retour_presta" rows="6" placeholder="Collez lien ici.."><?=($sousProjet->transportaiguillage !== NULL?$sousProjet->transportaiguillage->retour_presta:"")?></textarea>
                </div>
                <div class="col-md-4">
    ...
    var taiguillage_chambre_uploader_options = {
        ...
        onLoad:function(obj)
        {
            $.ajax({
                ...
                method:"POST",
                data: {id_objet:get('idsousprojet'),type_objet:'transport_aiguillage_chambre'},
                dataType: "json",
