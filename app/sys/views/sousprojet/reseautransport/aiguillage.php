            ...
            <div class="form-group">
                <div class="col-xs-12">
                    ...
                    <label class="css-input switch switch-sm switch-success">
                        ...
                        Prise en charge BE : <span id="charge_be_message_transport_aiguillage"><?= ($sousProjet->transportaiguillage!==NULL && $sousProjet->transportaiguillage->date_charge_be !=NULL ?" Le ".$sousProjet->transportaiguillage->date_charge_be."" : "")?></span>
                    </label>
                </div>
