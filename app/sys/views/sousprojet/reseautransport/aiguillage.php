            ...
            <div class="form-group">
                <div class="col-xs-12">
                    ...
                    <label class="css-input switch switch-sm switch-success">
                        <input id="id_sous_projet_transport_aiguillage_charge_be" class="a2tcheckbox" type="checkbox" value="FALSE" <?= ($sousProjet->transportaiguillage!==NULL && $sousProjet->transportaiguillage->date_charge_be !=NULL ?"checked" : "")?> ><span></span>
                        Charge BE prise en charge : <span id="charge_be_message_transport_aiguillage"><?= ($sousProjet->transportaiguillage!==NULL && $sousProjet->transportaiguillage->date_charge_be !=NULL ?" Le ".$sousProjet->transportaiguillage->date_charge_be."" : "")?></span>
                    </label>
                </div>
...
<div id="charge-be-confirm_transport_aiguillage" title="Confirmer cette affectation ?">
...
<script>
    ...
    $(document).ready(function() {
        ...
        var actif = null;
        $( "#charge-be-confirm_transport_aiguillage" ).dialog({
            autoOpen: false,
            resizable: false,
            height: "auto",
            width: 400,
                            ...
                            $.ajax({
                                ...
                                if(obj.error == 0) {
                                    if(obj.date_charge_be == null){
                                        $("#id_sous_projet_transport_aiguillage_charge_be").prop('checked',false);
                                        $( "#charge-be-confirm_transport_aiguillage" ).dialog( "close" );
                                        $("#charge_be_message_transport_aiguillage").html("" );
                                        App.showMessage(msg, '#message_transport_aiguillage');

                                    }else{
                                        $("#id_sous_projet_transport_aiguillage_charge_be").prop('checked',true);
                                        $( "#charge-be-confirm_transport_aiguillage" ).dialog( "close" );
                                        $("#charge_be_message_transport_aiguillage").html("Le " + obj.date_charge_be );
                                        App.showMessage(msg, '#message_transport_aiguillage');
        ...
        $('#id_sous_projet_transport_aiguillage_charge_be').click(function(e){
            e.preventDefault();
            $("#charge-be-confirm_transport_aiguillage").dialog("open");
        ...
        $("#id_sous_projet_transport_aiguillage_btn_osa").click(function () {
           if($( "#ta_intervenant_be" ).val()!="") liste_intervenant.push($( "#ta_intervenant_be" ).val());
        ...
        $("#id_sous_projet_transport_aiguillage_btn").click(function () {
            ...
            if($("#ta_ok").val() == 1) {
                $("#ta_etat_retour").val(2);
                aiguillage_formdata['ta_etat_retour'] = $("#ta_etat_retour").val();
            }
