...
<script>
    $(document).ready(function() {
        ...
        $("#update_entreprise").click(function() {
            $.ajax({
                method: "POST",
                url: "api/entreprise/entreprise/entreprise_update.php",
                data: {
                ...
                if(App.showMessage(message,'#message_entreprise_update')) {
                    update = true;
                }
        ...
        $('#update-entreprise').on('hidden.bs.modal', function () {
            if(update) {
