...
<script>
    $(document).ready(function() {
        ...
        $("#save_sub_project").click(function () {
            ...
            $.ajax({
                method: "POST",
                url: "api/projet/sousprojet/sous_projet_add.php",
                data: {
                    idp: projet_dt.row('.selected').data().id_projet,
                    dep: projet_dt.row('.selected').data().ville,
                    ville: projet_dt.row('.selected').data().ville_nom,
                    plaque: projet_dt.row('.selected').data().trigramme_dept,
