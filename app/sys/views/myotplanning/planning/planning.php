<div class="row">
    <div class="col-md-3">
        <div class="form-group">
            ...
            <select disabled class="form-control " id="ot_entreprise_cal" name="ot_entreprise_cal" style="width: 100%;">
                <?php
                $results = EntrepriseSTT::all(array("conditions" => "id_entreprise = ".$connectedProfil->profil->entreprise->id_entreprise));
                //var_dump($results);
...
<script>
    var calendar = function() {
        ...
        var initCalendar = function() {
            $('#calender').fullCalendar({
                ...
                events: {
                    url: 'api/ot/planningot/my_calendar_events.php',//mod
                ...
                eventClick: function(calEvent, jsEvent, view) {
                    ...
                    if(calEvent.id > 0) {
                        ...
                        $.ajax({
                            ...
                            dataType: "json",
                            data: {
                                ide: <?= $connectedProfil->profil->entreprise->id_entreprise?>
                            }
                        }).done(function (data) {
    ...
    $(document).ready(function() {
        ...
        $('#ot_entreprise_cal').select2('val','<?= $connectedProfil->profil->entreprise->id_entreprise?>');
