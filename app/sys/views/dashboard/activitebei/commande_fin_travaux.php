<div class="block block-themed" id="commande_fin_travaux_block">
    ...
    <!-- Fin de Commande de fin de travaux Hors Délais -->
    <div class="block-content">
        <!-- Page Content -->
    ...
    <!--saisie reference commande fin travaux-->
    <div class="block-content">
        <!-- Page Content -->
        <div class="content" id="saisie_reference_commande_fin_travaux_block_content">
            <div class="row">
                <div class="block">
                    <div class="block-header">
                        <h3 class="block-title">Saisie de la référence de Commande fin de Travaux</h3>
                    </div>
                    <div class="block-content bg-info-light">
                        <table id="saisie_reference_commande_fin_travaux_ctr_table1" class="table table-bordered table-striped js-dataTable-full" width="100%">
                            <thead>
                            <tr><th colspan="3">Réseau de Transport</th></tr>
                            <tr>
                                <th>Code Sous-projet</th>
                                <th>Date calculées J+5 (jours ouvrés) à partir de la date de Transmission TFX</th>
                                <th>BEI du NRO</th>
                            </tr>
                            </thead>
                            <tbody>
                    ...
                    <br />
                    <div class="block-content bg-info-light">
                        <table id="saisie_reference_commande_fin_travaux_cdi_table1" class="table table-bordered table-striped js-dataTable-full" width="100%">
                            <thead>
                            <tr><th colspan="3">Réseau de Distribution</th></tr>
                            <tr>
                                <th>Code Sous-projet</th>
    ...
    <!--commande refusé commande fin travaux-->
    <div class="block-content">
        <!-- Page Content -->
        <div class="content" id="commande_refuse_commande_fin_travaux_block_content">
            <div class="row">
                <div class="block">
                    <div class="block-header">
                    ...
                    <div class="block-content bg-info-light">
                        <table id="commande_refuse_commande_fin_travaux_ctr_table1" class="table table-bordered table-striped js-dataTable-full" width="100%">
                            <thead>
                            <tr><th colspan="3">Réseau de Transport</th></tr>
                            <tr>
                                <th>Code Sous-projet</th>
                    ...
                    <br />
                    <div class="block-content bg-info-light">
                        <table id="commande_refuse_commande_fin_travaux_cdi_table1" class="table table-bordered table-striped js-dataTable-full" width="100%">
                            <thead>
                            <tr><th colspan="3">Réseau de Distribution</th></tr>
                            <tr>
                                <th>Code Sous-projet</th>
...
var saisie_reference_commande_fin_travaux_cdi_dt;
...
var commande_refuse_commande_fin_travaux_ctr_dt;
    ...
    $(document).ready(function() {
        ...
        commande_fin_travaux_hors_delai_cdi_dt = $('#commande_fin_travaux_hors_delai_cdi_table1').on('preXhr.dt', function ( e, settings, data ) {
            $('#commande_fin_travaux_hors_delai_block').addClass('block-opt-refresh');
        }).DataTable( {
            "language": {
                "url": "assets/js/plugins/datatables/French.json"
         ...
         * saisie reference commande fin travaux
         */
        saisie_reference_commande_fin_travaux_ctr_dt = $('#saisie_reference_commande_fin_travaux_ctr_table1').on('preXhr.dt', function ( e, settings, data ) {
            $('#saisie_reference_commande_fin_travaux_block').addClass('block-opt-refresh');
        }).DataTable( {
            "language": {
                "url": "assets/js/plugins/datatables/French.json"
            },
            ...
            "serverSide": true,
            "ajax": {
                "url": 'api/dashboard/activitebei/saisie_reference_commande_fin_travaux_ctr_liste.php',
                "method":'POST'
            },
            "columns": [
                { "data": "code_sous_projet" },
                { "data": "date_transmission_tfx" },
                { "data": "bei_nro" }
            ],
            "columnDefs": [
                ...
                },
                {
                    ...
                    "data": "date_transmission_tfx",
                    "render": function ( data, type, full, meta ) {
                        if(full.date_transmission_tfx !=null   ) {
                            var dat = new Date(full.date_transmission_tfx);
            ...
            ,
            "drawCallback": function( settings ) {
                $('#saisie_reference_commande_fin_travaux_block').removeClass('block-opt-refresh');
            }
        } );
        saisie_reference_commande_fin_travaux_cdi_dt = $('#saisie_reference_commande_fin_travaux_cdi_table1').on('preXhr.dt', function ( e, settings, data ) {
            $('#saisie_reference_commande_fin_travaux_block').addClass('block-opt-refresh');
        }).DataTable( {
            "language": {
                "url": "assets/js/plugins/datatables/French.json"
            ...
            "serverSide": true,
            "ajax": {
                "url": 'api/dashboard/activitebei/saisie_reference_commande_fin_travaux_cdi_liste.php',
                "method":'POST'
            },
            "columns": [
                { "data": "code_sous_projet" },
         ...
         * Commande refusé
         */
        commande_refuse_commande_fin_travaux_ctr_dt = $('#commande_refuse_commande_fin_travaux_ctr_table1').on('preXhr.dt', function ( e, settings, data ) {
            $('#commande_refuse_commande_fin_travaux_block').addClass('block-opt-refresh');
        }).DataTable( {
            "language": {
                "url": "assets/js/plugins/datatables/French.json"
            },
            ...
            "serverSide": true,
            "ajax": {
                "url": 'api/dashboard/activitebei/commande_refuse_commande_fin_travaux_ctr_liste.php',
                "method":'POST'
            },
            "columns": [
                { "data": "code_sous_projet" },
        ...
        commande_refuse_commande_fin_travaux_cdi_dt = $('#commande_refuse_commande_fin_travaux_cdi_table1').on('preXhr.dt', function ( e, settings, data ) {
            $('#commande_refuse_commande_fin_travaux_block').addClass('block-opt-refresh');
        }).DataTable( {
            "language": {
                "url": "assets/js/plugins/datatables/French.json"
            ...
            "serverSide": true,
            "ajax": {
                "url": 'api/dashboard/activitebei/commande_refuse_commande_fin_travaux_cdi_liste.php',
                "method":'POST'
            },
            "columns": [
                { "data": "code_sous_projet" },
