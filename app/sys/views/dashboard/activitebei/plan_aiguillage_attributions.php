...
?>
<div class="block block-themed" id="plan_aiguillage_attributions_block">
    <div class="block-header bg-primary-light">
        <ul class="block-options">
            ...
            <li>
                <button id="plan_aiguillage_attributions_block_reduce" type="button" data-toggle="block-option" data-action="content_toggle" data-action-mode="demo"><i class="si si-arrow-up"></i></button>
            </li>
        </ul>
