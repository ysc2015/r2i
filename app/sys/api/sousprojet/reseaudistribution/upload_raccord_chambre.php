    ...
    if (isset($_FILES["myfile"])) {
        ...
        if (!is_array($_FILES["myfile"]["name"])) {
            ...
            if($stm->execute()) {
                ...
                $stm = $db->prepare("insert into chambre (id_sous_projet,id_ressource,type_entree,ref_chambre,villet,sous_projet,ref_note,code_ch1,code_ch2,gps) values (:id_sous_projet,:id_ressource,'distribution_raccord_chambre',:ref_chambre,:villet,:sous_projet,:ref_note,:code_ch1,:code_ch2,:gps)");
