...
if($sousProjet !== NULL) {
    if($sousProjet->distributiontirage !== NULL) {
        ...
        (isset($dt_intervenant_be))? $fieldslist .=",date_attribution_be = :date_attribution_be": $fieldslist.="" ;
        ...
        (isset($dt_intervenant_be))? $fieldslist .=",date_attribution_be ": $fieldslist.="" ;
        (isset($dt_intervenant_be))? $valueslist .=",:date_attribution_be ": $valueslist.="" ;
        if(/*isset($dt_plans) && */ isset($dt_controle_plans) && isset($dt_lien_plans)/* && $dt_plans == 3*/ && $dt_controle_plans == 2 && $dt_lien_plans != "") {
...
if($insert == true && $err == 0){
    ...
    if($stm->execute()){
        ...
        if($mailaction_new
            ...
            //envoi de mail
            $mailaction_html = get_content_html_mail_by_type($db,$sousProjet->projet->nro->lib_nro."-".$sousProjet->zone,'CDI','Tirage',4,'','','','','','','',$sousProjet->projet->id_chef_projet,$sousProjet->id_sous_projet);
        ...
        if($mailaction_new && (
            ...
            $mailaction_html = get_content_html_mail_by_type($db,$sousProjet->projet->nro->lib_nro."-".$sousProjet->zone,'CDI','Tirage',2,'','','','','','','',$sousProjet->projet->id_chef_projet,$sousProjet->id_sous_projet);
            $mailaction_object = $mailaction_html[1];
            $mailaction_html =  $mailaction_html[0];
        ...
        if($mailaction_new
            ...
            $mailaction_html = get_content_html_mail_by_type($db,$sousProjet->projet->nro->lib_nro."-".$sousProjet->zone,'CDI','Tirage',7,'','','','','','','',$sousProjet->projet->id_chef_projet,$sousProjet->id_sous_projet);
            $mailaction_object = $mailaction_html[1];
            $mailaction_html =  $mailaction_html[0];
