<?php
/**
 * file: upload_vpi_survey_file.php
 * User: rabii
 */
...
$err = 0;
$message = array();
$stm = $db->prepare("insert into ressource (id_sous_projet,type_objet,nom_fichier,nom_fichier_disque,dossier,date_creation) values (:id_sous_projet,'vpi_survey',:nom_fichier,:nom_fichier_disque,'sousprojets',:date_creation)");
