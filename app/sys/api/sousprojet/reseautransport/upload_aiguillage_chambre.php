...
$err = 0;
$message = array();
$stm = $db->prepare("insert into ressource (id_objet,type_objet,nom_fichier,nom_fichier_disque,dossier,date_creation) values (:id_objet,'transport_aiguillage_chambre',:nom_fichier,:nom_fichier_disque,'chambres',:date_creation)");
