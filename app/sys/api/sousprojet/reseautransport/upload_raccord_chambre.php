<?php
/**
 * file: upload_raccord_chambre.php
 * User: rabii
 */
...
$err = 0;
$message = array();
$stm = $db->prepare("insert into ressource (id_sous_projet,type_objet,nom_fichier,nom_fichier_disque,dossier,date_creation) values (:id_sous_projet,'transport_raccord_chambre',:nom_fichier,:nom_fichier_disque,'chambres',:date_creation)");
    ...
    if (isset($_FILES["myfile"])) {
        ...
        if (!is_array($_FILES["myfile"]["name"])) {
            ...
            if($stm->execute()) {
                ...
                $stm = $db->prepare("insert into chambre (id_sous_projet,id_ressource,type_entree,ref_chambre,villet,sous_projet,ref_note,code_ch1,code_ch2,gps) values (:id_sous_projet,:id_ressource,'transport_raccord_chambre',:ref_chambre,:villet,:sous_projet,:ref_note,:code_ch1,:code_ch2,:gps)");
