...
$err = 0;
$message = array();
$stm = $db->prepare("insert into ressource (id_objet,type_objet,nom_fichier,nom_fichier_disque,dossier,date_creation) values (:id_objet,'tr_pboite_files',:nom_fichier,:nom_fichier_disque,'plansboites',:date_creation)");
