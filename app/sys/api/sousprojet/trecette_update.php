...
$err = 0;
$message = array();
$stm = $db->prepare("update sous_projet_transport_recette set intervenant_be=:intervenant_be,doe=:doe,netgeo=:netgeo,intervenant_free=:intervenant_free,id_entreprise=:id_entreprise,date_recette=:date_recette,etat_recette=:etat_recette where id_sous_projet=:id_sous_projet");
