...
$err = 0;
$message = array();
$stm = $db->prepare("update sous_projet_zone set nbr_zone=:nbr_zone,lr_sur_pm=:lr_sur_pm,lr=:lr,nbr_de_site=:nbr_de_site,nb_fo_sur_pm=:nb_fo_sur_pm,nb_fo_sur_pmz=:nb_fo_sur_pmz where  id_sous_projet=:id_sous_projet");
