...
$columns = array(
    ...
    array( "db" => "t6.retour_presta as ctr_aiguillage_retour_presta", "dt" => 'ctr_aiguillage_retour_presta' ),
    ...
    array( "db" => "t7.commandes_acces as ctr_aiguillage_lib_commande_acces", "dt" => 'ctr_aiguillage_lib_commande_acces' ),
    ...
    array( "db" => "t77.commandes_fin_travaux as ctr_aiguillage_lib_commande_acces2", "dt" => 'ctr_aiguillage_lib_commande_acces2' ),
    ...
    array( "db" => "t8.retour_presta as ctr_tirage_retour_presta", "dt" => 'ctr_tirage_retour_presta' ),
    ...
    array( "db" => "t9.retour_presta as ctr_raccord_retour_presta", "dt" => 'ctr_raccord_retour_presta' ),
    ...
    array( "db" => "t11.retour_presta as cdi_aiguillage_retour_presta", "dt" => 'cdi_aiguillage_retour_presta' ),
    ...
    array( "db" => "t12.commandes_acces as cdi_aiguillage_lib_commande_acces", "dt" => 'cdi_aiguillage_lib_commande_acces' ),
    ...
    array( "db" => "t122.commandes_fin_travaux as cdi_aiguillage_lib_commande_acces22", "dt" => 'cdi_aiguillage_lib_commande_acces22' ),
    ...
    array( "db" => "t13.retour_presta as cdi_tirage_retour_presta", "dt" => 'cdi_tirage_retour_presta' ),
    ...
    array( "db" => "t14.retour_presta as cdi_raccord_retour_presta", "dt" => 'cdi_raccord_retour_presta' ),
...
$left .= " left join sous_projet_transport_aiguillage t6 left join select_controle_plan scp1 on t6.controle_plans=scp1.id_controle_plan left join ordre_de_travail ot1 left join ot_last_stt_upload olsu1 on ot1.id_ordre_de_travail = olsu1.id_ordre_de_travail and olsu1.id_type_ordre_travail = 1 left join blq_pbc_unresolved bpu1 on ot1.id_ordre_de_travail = bpu1.id_ordre_de_travail left join blq_pbc_unanswered bpua1 on ot1.id_ordre_de_travail = bpua1.id_ordre_de_travail on t6.id_sous_projet=ot1.id_sous_projet and ot1.id_type_ordre_travail = 1 left join select_etat_retour ser1 on t6.etat_retour=ser1.id_etat_retour on t1.id_sous_projet = t6.id_sous_projet";

$left .= " left join sous_projet_transport_commande_ctr t7 left join select_go_ft sgf1 on t7.go_ft=sgf1.id_go_ft on t1.id_sous_projet = t7.id_sous_projet";//left join select_commande_acces sca1 on t7.commandes_acces = sca1.id_commande_acces

$left .= " left join sous_projet_transport_commande_fin_travaux t77 left join select_go_ft sgf11 on t77.go_ft=sgf11.id_go_ft on t1.id_sous_projet = t77.id_sous_projet";//left join select_commande_acces sca11 on t77.commandes_fin_travaux = sca11.id_commande_acces

$left .= " left join sous_projet_transport_tirage t8 left join select_controle_plan scp2 on t8.controle_plans=scp2.id_controle_plan left join ordre_de_travail ot2 left join ot_last_stt_upload olsu2 on ot2.id_ordre_de_travail = olsu2.id_ordre_de_travail and olsu2.id_type_ordre_travail IN (2,4) left join blq_pbc_unresolved bpu2 on ot2.id_ordre_de_travail = bpu2.id_ordre_de_travail left join blq_pbc_unanswered bpua2 on ot2.id_ordre_de_travail = bpua2.id_ordre_de_travail on t8.id_sous_projet=ot2.id_sous_projet and ot2.id_type_ordre_travail IN (2,4) left join select_etat_retour ser2 on t8.etat_retour=ser2.id_etat_retour on t1.id_sous_projet = t8.id_sous_projet";

$left .= " left join sous_projet_transport_raccordements t9 left join select_controle_plan scp3 on t9.controle_plans=scp3.id_controle_plan left join ordre_de_travail ot3 left join ot_last_stt_upload olsu3 on ot3.id_ordre_de_travail = olsu3.id_ordre_de_travail and olsu3.id_type_ordre_travail IN (3,4) left join blq_pbc_unresolved bpu3 on ot3.id_ordre_de_travail = bpu3.id_ordre_de_travail left join blq_pbc_unanswered bpua3 on ot3.id_ordre_de_travail = bpua3.id_ordre_de_travail on t9.id_sous_projet=ot3.id_sous_projet and ot3.id_type_ordre_travail IN (3,4) left join select_etat_retour ser3 on t9.etat_retour=ser3.id_etat_retour on t1.id_sous_projet = t9.id_sous_projet";
...
$left .= " left join sous_projet_distribution_aiguillage t11 left join select_controle_plan scp4 on t11.controle_plans=scp4.id_controle_plan left join ordre_de_travail ot4 left join ot_last_stt_upload olsu4 on ot4.id_ordre_de_travail = olsu4.id_ordre_de_travail and olsu4.id_type_ordre_travail = 5 left join blq_pbc_unresolved bpu4 on ot4.id_ordre_de_travail = bpu4.id_ordre_de_travail left join blq_pbc_unanswered bpua4 on ot4.id_ordre_de_travail = bpua4.id_ordre_de_travail on t11.id_sous_projet=ot4.id_sous_projet and ot4.id_type_ordre_travail = 5 left join select_etat_retour ser4 on t11.etat_retour=ser4.id_etat_retour on t1.id_sous_projet = t11.id_sous_projet";

$left .= " left join sous_projet_distribution_commande_cdi t12 left join select_go_ft sgf2 on t12.go_ft=sgf2.id_go_ft on t1.id_sous_projet = t12.id_sous_projet";//left join select_commande_acces sca2 on t12.commandes_acces = sca2.id_commande_acces

$left .= " left join sous_projet_distribution_commande_fin_travaux t122 left join select_go_ft sgf22 on t122.go_ft=sgf22.id_go_ft on t1.id_sous_projet = t122.id_sous_projet";//left join select_commande_acces sca22 on t122.commandes_fin_travaux = sca22.id_commande_acces

$left .= " left join sous_projet_distribution_tirage t13 left join select_controle_plan scp5 on t13.controle_plans=scp5.id_controle_plan left join ordre_de_travail ot5 left join ot_last_stt_upload olsu5 on ot5.id_ordre_de_travail = olsu5.id_ordre_de_travail and olsu5.id_type_ordre_travail IN (6,8) left join blq_pbc_unresolved bpu5 on ot5.id_ordre_de_travail = bpu5.id_ordre_de_travail left join blq_pbc_unanswered bpua5 on ot5.id_ordre_de_travail = bpua5.id_ordre_de_travail on t13.id_sous_projet=ot5.id_sous_projet and ot5.id_type_ordre_travail IN (6,8) left join select_etat_retour ser5 on t13.etat_retour=ser5.id_etat_retour on t1.id_sous_projet = t13.id_sous_projet";

$left .= " left join sous_projet_distribution_raccordements t14 left join select_controle_plan scp6 on t14.controle_plans=scp6.id_controle_plan left join ordre_de_travail ot6 left join ot_last_stt_upload olsu6 on ot6.id_ordre_de_travail = olsu6.id_ordre_de_travail and olsu6.id_type_ordre_travail IN (7,8) left join blq_pbc_unresolved bpu6 on ot6.id_ordre_de_travail = bpu6.id_ordre_de_travail left join blq_pbc_unanswered bpua6 on ot6.id_ordre_de_travail = bpua6.id_ordre_de_travail on t14.id_sous_projet=ot6.id_sous_projet and ot6.id_type_ordre_travail IN (7,8) left join select_etat_retour ser6 on t14.etat_retour=ser6.id_etat_retour on t1.id_sous_projet = t14.id_sous_projet";//left join select_ok sodr on t14.ok=sodr.id_ok
