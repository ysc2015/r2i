...
$columns = array(
    ...
    array( "db" => "if(t6.lineaire4>0,t6.lineaire4,t5.lineaire4) as t6_lineaire4", "dt" => 't6_lineaire4' ),
    ...
    array( "db" => "if(t6.lineaire5>0,t6.lineaire5,t5.lineaire5) as t6_lineaire5", "dt" => 't6_lineaire5' ),
    array( "db" => "if(t6.lineaire6>0,t6.lineaire6,t5.lineaire6) as t6_lineaire6", "dt" => 't6_lineaire6' ),
    array( "db" => "if(t6.lineaire7>0,t6.lineaire7,t5.lineaire7) as t6_lineaire7", "dt" => 't6_lineaire7' ),
    array( "db" => "if(t6.lineaire8>0,t6.lineaire8,t5.lineaire8) as t6_lineaire8", "dt" => 't6_lineaire8' ),
    array( "db" => "if(t6.lineaire13>0,t6.lineaire13,t5.lineaire9) as t6_lineaire13", "dt" => 't6_lineaire13' ),
    array( "db" => "if(t6.lineaire14>0,t6.lineaire14,t5.lineaire10) as t6_lineaire14", "dt" => 't6_lineaire14' ),
    //CDI
    //Aiguillage
