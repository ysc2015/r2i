...
$err = 0;
$message = array();
$stm = $db->prepare("insert into ressource (id_projet,type_objet,nom_fichier,nom_fichier_disque,dossier,date_creation) values (:id_projet,'fichier_contour',:nom_fichier,:nom_fichier_disque,'projets',:date_creation)");
