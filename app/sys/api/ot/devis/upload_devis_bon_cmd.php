...
$err = 0;
$message = array();
$stm = $db->prepare("insert into ressource (iddevis,type_objet,nom_fichier,nom_fichier_disque,dossier,date_creation) values (:iddevis,'devis_bon_cmd',:nom_fichier,:nom_fichier_disque,'devis',:date_creation)");
