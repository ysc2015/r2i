<?php
/**
 * file: question_pbc_upload_retour.php
 * User: rabii
 */
...
$ret = array();
$stm = $db->prepare("insert into ressource (id_blq_pbc,type_objet,nom_fichier,nom_fichier_disque,dossier,date_creation) values (:id_blq_pbc,'pbc_question',:nom_fichier,:nom_fichier_disque,'sousprojets',:date_creation)");
