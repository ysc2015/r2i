...
$err = 0;
$message = array();
$stm = $db->prepare("insert into utilisateur (nom_utilisateur,prenom_utilisateur,email_utilisateur,pass_utilisateur,id_profil_utilisateur,id_entreprise) values (:nom,:prenom,:email,:pwd,2,:id_entreprise)");
