...
echo json_encode(SSP::simpleJoin($_GET,$db,$table,"id_nro",$columns,"","right join nro as n on u.id_utilisateur = n.id_utilisateur left join profil_utilisateur as pu on u.id_profil_utilisateur = pu.id_profil_utilisateur"));