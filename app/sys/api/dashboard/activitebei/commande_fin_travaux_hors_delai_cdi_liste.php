...
$table = array("sous_projet as t1","projet as t2","nro as t3","`sous_projet_distribution_commande_fin_travaux` as t5" );
$columns = array(
...
$condition .= " AND (t5.date_transmission_tfx = '0000-00-00' OR t5.date_transmission_tfx = '' OR t5.date_transmission_tfx IS NULL )  ";
$condition .= " AND t5.intervenant_be != 0 AND t5.intervenant_be IS not NULL and t5.intervenant_be != ''   ";
