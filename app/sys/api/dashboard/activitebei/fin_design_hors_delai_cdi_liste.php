...
$tat = get_date_to_compare_ouvre(date('Y-m-d'),5);
$date_plus_5_jours = $tat->format('Y-m-d');


$table = array("sous_projet as t1","projet as t2","nro as t3","`sous_projet_distribution_design` as t5" );
$columns = array(
