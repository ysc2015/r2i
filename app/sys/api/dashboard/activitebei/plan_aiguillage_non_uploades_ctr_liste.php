 ...
 */
extract($_POST);
//Liste des CTR pour lesquels le design est terminé mais pour lesquels les plans d’aiguillage ne sont pas « Contrôlés OK » ou « Lien vers les plans » est vide.
$table = array("sous_projet as t1","projet as t2","nro as t3","ordre_de_travail as t4","`sous_projet_transport_design` as t5","`sous_projet_transport_aiguillage` as t9" );
$columns = array(
