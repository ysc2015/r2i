...
$columns = array(
    ...
    array( "db" => "t5.date_transmission_tfx", "dt" => 'date_transmission_tfx' ),
...
$condition .= " AND ((t5.date_transmission_tfx  + interval 5 day) < now())";
$condition .= " AND (t5.ref_commande_fin_travaux  IS NULL or  t5.ref_commande_fin_travaux ='' )   ";
