...
$table = array("sous_projet as t1","projet as t2","nro as t3","`sous_projet_transport_recette` as t5","ressource as t9" );
$columns = array(
    ...
    array( "db" => "t5.date_attribution_doe", "dt" => 'date_attribution_doe' ),
...
$condition .= " AND ((t5.date_attribution_doe + interval 3 day) < now())";
$condition .= " AND t5.doe != 0 AND t5.doe IS not NULL and t5.doe != ''   ";
